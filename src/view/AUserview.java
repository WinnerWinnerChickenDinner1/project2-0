 ...
 * @author  __USER__
 */
public class AUserview extends javax.swing.JFrame {

	/** Creates new form AUserview */
	public AUserview() {
	...
	private void initComponents() {
		...
		jButton8.setBackground(new java.awt.Color(110, 123, 129));
		...
		jPanel3Layout.setVerticalGroup(jPanel3Layout.createParallelGroup(
				javax.swing.GroupLayout.Alignment.LEADING).addComponent(
				jScrollPane1, javax.swing.GroupLayout.DEFAULT_SIZE, 719,
				Short.MAX_VALUE));
		...
		jPanel1Layout.setHorizontalGroup(jPanel1Layout.createParallelGroup(
				...
				.addComponent(jPanel3, javax.swing.GroupLayout.DEFAULT_SIZE,
						javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
				.addGroup(
						jPanel1Layout.createSequentialGroup().addGap(405, 405,
								405).addComponent(jButton6,
	...
	private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {
		...
		new Company().deleteVip(vips[jTable1.getSelectedRow()][0].toString());
		vips = new Company().showVip();
		jTable1.setModel(new javax.swing.table.DefaultTableModel(vips,
				new String[] { "用户编号", "用户姓名", "备注", "用户余额" }));
	}
	}
	...
	private Object[][] vips = new Company().showVip();
